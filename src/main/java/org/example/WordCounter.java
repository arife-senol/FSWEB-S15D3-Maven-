...
public class WordCounter {
    public static Map<String, Integer> calculatedWord() {
        ...
        // Metni kelimelere ayırıyoruz. Boşluk, noktalama işaretleri ve diğer özel karakterler ile ayırma yapıyoruz.
        String[] words = text.toLowerCase().split("[\\s,.]+");

        // Her kelimenin frekansını hesaplayıp, haritaya ekliyoruz.
        for (String word : words) {
            if (!word.isEmpty()) { // Boş kelimeleri dikkate almıyoruz.
